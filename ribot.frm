...
If txtcari.Text = Char Then
sql = "select * from APOTEK where NMGenerik like '%" & txtcari.Text & "%' order by NMGenerik asc"
adopen.RecordSource = sql
adopen.Refresh
ElseIf txtcari.Text = "Cari" Then
MsgBox "Silahkan ketik data sesuai dengan nama jenis obat yang dibutuhkan !", vbCritical, "   Not Typed"
Else
MsgBox "Silahkan ketik data sesuai dengan nama jenis obat yang dibutuhkan !", vbCritical, "   I.N.F.O 001"
txtcari.SetFocus
End If
End Sub
...
If adopen.Recordset.Fields(3) <= 0 Then
 adopen.Recordset.Fields(3) = 0
 
 MsgBox "Data Stok Item yang anda ingin kan telah kosong", vbYesNo + vbInformation
 x = MsgBox("Silahkan Input Data Stok Item", vbYesNo + vbInformation)
  If x = vbYes Then
  Unload jumlah
  Unload resep2
  menu.Show
  ...
  End If
 Else
   resep2.nb1.Text = adopen.Recordset.Fields(1)
   resep2.j11.Text = adopen.Recordset.Fields(2)
   jumlah.namakomp.Text = adopen.Recordset.Fields(1)
   jumlah.jumlahkomp.Text = adopen.Recordset.Fields(3)
   Unload Me
   jumlah.Show
   jumlah.angka.SetFocus
   
   sql = "select * from APOTEK where NMGenerik like '%" & resep2.nb1.Text & "%' order by NMGenerik asc"
   jumlah.adopen.RecordSource = sql
   jumlah.adopen.Refresh
End If
ElseIf resep2.index.Text = "2" Then
 ...
 x = MsgBox("Silahkan Input Data Stok Item", vbYesNo + vbInformation)
  ...
  End If
 Else
   resep2.nb2.Text = adopen.Recordset.Fields(1)
   resep2.j22.Text = adopen.Recordset.Fields(2)
   jumlah.namakomp.Text = adopen.Recordset.Fields(1)
   jumlah.jumlahkomp.Text = adopen.Recordset.Fields(3)
   Unload Me
   jumlah.Show
...
ElseIf resep2.index.Text = "3" Then
 ...
 Unload jumlah
  ...
  End If
 Else
   resep2.nb3.Text = adopen.Recordset.Fields(1)
   resep2.j33.Text = adopen.Recordset.Fields(2)
   jumlah.namakomp.Text = adopen.Recordset.Fields(1)
   jumlah.jumlahkomp.Text = adopen.Recordset.Fields(3)
   Unload Me
   jumlah.Show
...
ElseIf resep2.index.Text = "4" Then
 ...
 x = MsgBox("Silahkan Input Data Stok Item", vbYesNo + vbInformation)
  ...
  End If
 Else
   resep2.nb4.Text = adopen.Recordset.Fields(1)
   resep2.j44.Text = adopen.Recordset.Fields(2)
   jumlah.namakomp.Text = adopen.Recordset.Fields(1)
   jumlah.jumlahkomp.Text = adopen.Recordset.Fields(3)
   Unload Me
   jumlah.Show
...
ElseIf resep2.index.Text = "5" Then
 ...
 x = MsgBox("Silahkan Input Data Stok Item", vbYesNo + vbInformation)
  ...
  End If
 Else
   resep2.nb5.Text = adopen.Recordset.Fields(1)
   resep2.j55.Text = adopen.Recordset.Fields(2)
   jumlah.namakomp.Text = adopen.Recordset.Fields(1)
   jumlah.jumlahkomp.Text = adopen.Recordset.Fields(3)
   Unload Me
   jumlah.Show
...
dgpen.Refresh
dgpen.Columns(1).Width = 5004
dgpen.Columns(2).Width = 1500
dgpen.Columns(3).Width = 900
End Sub
