...
inputstok.nama.Text = adopen.Recordset.Fields(3)
inputstok.harga.Text = adopen.Recordset.Fields(7)
inputstok.satuan.Text = adopen.Recordset.Fields(5)
inputstok.idob.Text = adopen.Recordset.Fields(0)
inputstok.namaa.Text = adopen.Recordset.Fields(3)
Unload Me
End Sub
Private Sub Form_Load()
sql = "select * from DBINDUK"
adopen.RecordSource = sql
adopen.Refresh
Set dgpen.DataSource = adopen
dgpen.Refresh
dgpen.Columns(3).Width = 9500
...
txtcari.Text = ""
Else
sql = "select * from DBINDUK where NMGenerik like '%" & txtcari.Text & "%' order by NMGenerik asc"
adopen.RecordSource = sql
adopen.Refresh
dgpen.Columns(3).Width = 9500
End If
